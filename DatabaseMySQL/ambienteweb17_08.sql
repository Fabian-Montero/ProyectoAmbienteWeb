...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Aug 18, 2023 at 11:23 AM
...
INSERT INTO `ambienteweb11_08`.`usuario_carrito`
(`cliente_id`,
`producto_id`,
`cantidad_productos`,
`total`)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `connsultarResumenCarrito` (IN `pIdUsuario` INT)   BEGIN
...
SELECT sum(cantidad_productos) 'Cantidad',
sum(total) 'Total'
FROM usuario_carrito 
WHERE 
cliente_id = pIdUsuario;
...
INSERT INTO `ambienteweb11_08`.`usuario_curso`
...
CREATE TABLE `usuario_curso` (
  `usuario_curso_id` int(11) NOT NULL,
  `cliente_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `cantidad_productos` int(11) NOT NULL,
  `total` decimal(10,2) DEFAULT NULL
...
INSERT INTO `usuario_curso` (`usuario_curso_id`, `cliente_id`, `producto_id`, `cantidad_productos`, `total`) VALUES
(1, 12, 954, 3, '2697.00'),
(2, 12, 960, 1, '1499.00'),
(3, 12, 953, 1, '549.00'),
(4, 12, 982, 2, '60.00'),
...
ALTER TABLE `usuario_curso`
  ADD PRIMARY KEY (`usuario_curso_id`),
...
--
ALTER TABLE `usuario_carrito`
  MODIFY `usuario_carrito_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `usuario_curso`
--
ALTER TABLE `usuario_curso`
  MODIFY `usuario_curso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `usuario_curso`
  ADD CONSTRAINT `usuario_curso_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  ADD CONSTRAINT `usuario_curso_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`);
COMMIT;
