            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Lo último en hombres</h2>
                        <span>Ropa de todo tipo para hombres</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="women">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Lo último en mujeres</h2>
                        <span>Ropa de todo tipo para mujeres</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section" id="kids">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-heading">
                        <h2>Lo último en niños</h2>
                        <span>Ropa y juguetes de todo tipo para niños</span>
                    </div>
                </div>
            </div>
        </div>
