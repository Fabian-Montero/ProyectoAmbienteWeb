...
-->
    ...
    <h2 class="text-primary">Mantenimiento</h2>
    ...
    <script>
        ...
        function actualizar(id) {
                ...
                var apellidoInput = document.getElementById("apellido_" + id);
                
                var nuevoNombre = nombreInput.value;
                var nuevoApellido = apellidoInput.value;
                
                console.log("Clicked on the 'Actualizar' button for row " + id + ". New nombre:", nuevoNombre, "New apellido:", nuevoApellido);
                updateUsuario(id, nuevoNombre, nuevoApellido);
