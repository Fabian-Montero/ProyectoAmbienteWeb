            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        ...
                        <span>Bienvenido al mantenimiento de productos</span>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                <div class="  d-flex justify-content-between align-items-center mb-5">
                                                    ...
                                                    <h6 class="mb-0 text-muted"> <?php echo$_SESSION["cantidadProductosMantenimiento"];?> items</h6>
